...
Public Class WebForm2
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If dt.Rows.Count = 5 Then
            ...
            Label38.Text = (Convert.ToDouble(Label33.Text) + Convert.ToDouble(Label34.Text) + Convert.ToDouble(Label35.Text) + Convert.ToDouble(Label36.Text) + Convert.ToDouble(Label37.Text))
        ElseIf dt.Rows.Count = 4 Then
            ...
            Label26.Text = dt.Rows(3).Item(1)
            Label36.Text = dt.Rows(3).Item(2)
            Label38.Text = (Convert.ToDouble(Label33.Text) + Convert.ToDouble(Label34.Text) + Convert.ToDouble(Label35.Text) + Convert.ToDouble(Label36.Text))
        ElseIf dt.Rows.Count = 3 Then
            ...
            Label23.Text = dt.Rows(2).Item(1)
            Label35.Text = dt.Rows(2).Item(2)
            Label38.Text = (Convert.ToDouble(Label33.Text) + Convert.ToDouble(Label34.Text) + Convert.ToDouble(Label35.Text))
        ElseIf dt.Rows.Count = 2 Then
            ...
            Label20.Text = dt.Rows(1).Item(1)
            Label34.Text = dt.Rows(1).Item(2)
            Label38.Text = (Convert.ToDouble(Label33.Text) + Convert.ToDouble(Label34.Text))
    ...
    Protected Sub Button2_Click(ByVal sender As Object, ByVal e As EventArgs) Handles Button2.Click
        ' Panel3.Visible = True
        Response.Redirect("shipping.aspx?Data=" & Server.UrlEncode(Label39.Text))
    End Sub
