                       ...
                       <legend>Registration Form <i class="fa fa-pencil pull-right"></i></legend>
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="please enter Email"  ControlToValidate="TextBox1" Font-Overline="False" ></asp:RequiredFieldValidator>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="please enter Paasword"  ControlToValidate="TextBox2" Font-Overline="False" ></asp:RequiredFieldValidator>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="please enter Address"  ControlToValidate="TextBox3" Font-Overline="False" ></asp:RequiredFieldValidator>
                            </div>
                        </div>
                        <div class="form-group">
